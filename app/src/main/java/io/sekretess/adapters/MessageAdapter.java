...
public class MessageAdapter extends RecyclerView.Adapter<ConcreteChatCustomViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ConcreteChatCustomViewHolder holder, int position) {
        ...
        holder.getMessageDate().setText(DateTimeFormatter.ofPattern("MMMM dd").withZone(ZoneId.systemDefault()).format(dateTimeFormatter.parse(messageRecordDto.getMessageDate())));
        holder.getMessageTime().setText(DateTimeFormatter.ofPattern("HH:mm").withZone(ZoneId.systemDefault()).format(dateTimeFormatter.parse(messageRecordDto.getMessageDate())));
    }
